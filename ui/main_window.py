...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #此处修改渐变色
        #rgb(120,205,200), stop:1 rgb(5,150,229))
        self.Main_QF.setStyleSheet(u"QFrame#Main_QF{\n"
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(246,211,101), stop:1 rgb(253,160,133));\n"
...
"}")
        ...
        # ------------------------------------------------------- 侧边栏
        self.logo.setStyleSheet(u"image: url(:/all/img/lg.png;\n"
...
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(77,162,203),  stop:1 rgb(103,178,111));\n"
...
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(224,185,255),  stop:1 rgb(255,154,158));\n"
...
"}")
        ...
        #
        #(206,255,254), stop:1 rgb(206,248,212)
        self.below.setStyleSheet(u"QFrame#below{\n"
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(161,196,253), stop:1 rgb(194,233,251));\n"
"border:0px solid red;\n"
"border-radius:30px\n"
"}")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"by Lx", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"USTC", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"基于YOLOv8的车辆检测系统", None))
        ...
        self.status_bar.setText(QCoreApplication.translate("MainWindow", u"欢迎使用车辆检测系统!", None))
